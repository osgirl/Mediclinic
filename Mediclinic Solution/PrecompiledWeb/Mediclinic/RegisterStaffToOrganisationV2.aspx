<%@ page title="Organisation List" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="RegisterStaffToOrganisationV2, App_Web_v0sheksw" %>
                    ...
                    <table class="block_center">
                        <tr>
                            ...
                            <td style="text-align:left;color:blue;width:525px;">
                                <center>
                                    <a href="#" onclick="show_hide('help_link'); return false;">Not Showing On Booking Screen? Click Here.</a>
                                </center>
                                <span id="help_link" style="display:none;">
                                    * Note that to be showing in the booking sheet, the following must be done:
                                    <ol>
                                    <li>Staff member below set to work <u>on that weekday</u></li>
                ...
                <div id="autodivheight" class="divautoheight" style="height:500px;">
                    ...
                    <asp:GridView ID="GrdRegistration" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Staff Member" HeaderStyle-HorizontalAlign="Left" SortExpression="surname,firstname,middlename" FooterStyle-VerticalAlign="Top" ItemStyle-CssClass="text_left"> 
                                <EditItemTemplate> 
