<%@ page title="Staff Detail" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="StaffDetailV2, App_Web_o4dos14t" %>
                        ...
                        <td style="width:500px;">
                            ...
                            <table class="detailtable_staff">
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><asp:DropDownList ID="ddlCostCentre" runat="server" DataTextField="descr" DataValueField="costcentre_id" TabIndex="20"/><asp:Label ID="lblCostCentre" runat="server" Font-Bold="True"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><asp:CheckBox ID="chkIsFired" runat="server"  TabIndex="24" /><asp:Label ID="lblIsFired" runat="server" Font-Bold="True"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><asp:TextBox ID="txtPwd" runat="server" TabIndex="10"></asp:TextBox><asp:Label ID="lblPwd" runat="server" Font-Bold="True"/></td>
                                    <td></td>
                                    <td></td>
