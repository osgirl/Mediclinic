<%@ page title="Maintain Letters" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="Letters_MaintainV2, App_Web_g1nxmnfz" %>
                ...
                <table style="min-width:250px;" class="block_center">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" onclick="show_hide('div_fields_list'); return false">Show/Hide Fields</a><br />
            ...
            <table id="spn_manage_files" runat="server" class="block_center vertical_align_top">
                ...
                <tr>
                    <td colspan="4" style="text-align:center;">
                            ...
                            <a href="#" onclick="show_hide('div_invfields_list'); return false" style="white-space:nowrap">Show/Hide Invoice Fields</a><br />
