<%@ page title="Call Centre" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="CallCenterV2, App_Web_g1nxmnfz" validaterequest="false" %>
    ...
    <div class="clearfix">
        ...
        <div class="main_content_with_header">
            ...
            <center>
                ...
                <a href="#" onclick="show_all('heading_');return false;">Show All Clinics/Facs</a> 
                &nbsp;&nbsp;&nbsp;
                <a href="#" onclick="hide_all('heading_');return false;">Hide All Clinics/Facs</a>
