<%@ page title="Staff List" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="StaffListV2, App_Web_o4dos14t" %>
            ...
            <div class="user_login_form">
                ...
                <div class="border_top_bottom">
                    <center>
                        ...
                        <span style="padding-left:20px;"><asp:CheckBox ID="chkShowFired" runat="server" AutoPostBack="True" OnCheckedChanged="chkShowFired_CheckedChanged" Checked="False" /> &nbsp;<label for="chkShowFired" style="font-weight:normal;">show fired</label> </span>
                    </center>
                </div>
                    ...
                    <asp:GridView ID="GrdStaff" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Password" HeaderStyle-HorizontalAlign="Left" SortExpression="pwd"> 
                                <EditItemTemplate> 
                                    <asp:TextBox Width="90%" ID="txtPwd" runat="server" Text='<%# Bind("pwd") %>'></asp:TextBox> 
                            ...
                            <asp:TemplateField HeaderText="Cost Centre" HeaderStyle-HorizontalAlign="Left" SortExpression="costcentre_descr" FooterStyle-VerticalAlign="Top"> 
                                <EditItemTemplate> 
                            ...
                            <asp:TemplateField HeaderText="Fired" SortExpression="is_fired" FooterStyle-VerticalAlign="Top"> 
                                <EditItemTemplate> 
                                    <asp:CheckBox ID="chkIsFired" runat="server" Checked='<%#Eval("is_fired").ToString()=="True"?true:false %>' />
                                </EditItemTemplate> 
                                <ItemTemplate> 
                                    <asp:Label ID="lblIsFired" runat="server" Text='<%# Eval("is_fired").ToString()=="True"?"Yes":"No" %>'></asp:Label> 
                                </ItemTemplate> 
                            </asp:TemplateField> 
