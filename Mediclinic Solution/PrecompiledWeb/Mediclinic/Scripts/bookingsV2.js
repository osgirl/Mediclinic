...
function show_modal_complete_booking(t_id, type, show_as_popup) {
    ...
    if (show_as_popup) {
        ...
        var result = is_clinic ?
            window.showModalDialog('BookingCreateInvoiceV2.aspx?booking=' + booking_id + '&type=' + type, '', 'dialogHide:yes;dialogWidth:1325px;dialogHeight:800px;center:yes;resizable:no; scroll:no') :
            window.showModalDialog('BookingCreateInvoiceAgedCareV2.aspx?booking=' + booking_id + '&type=' + type + '&completion_type=standard', '', 'dialogHide:yes;dialogWidth:1275px;dialogHeight:800px;center:yes;resizable:no; scroll:no');
        ...
        var url = is_clinic ?
            ('BookingCreateInvoiceV2.aspx?booking=' + booking_id + '&type=' + type + "&refresh_on_close=1") :
            ('BookingCreateInvoiceAgedCareV2.aspx?booking=' + booking_id + '&type=' + type + '&completion_type=standard&refresh_on_close=1');
...
function show_modal_add_box(t_id, add_multiple_days) {
    ...
    var minimum_booking_minutes = document.getElementById('lblMinBookingDurationMins').innerHTML; //10;  // (getUrlVars()["type"] == "agedcare") || is_agedcare ? 60 : 10;
    ...
    var IsPatientLogin = get_lbl_data('lblIsPatientLogin') == "1";
    if (IsPatientLogin) {
    ...
    if (add_multiple_days) {
        ...
        document.getElementById('spnModalPage').style.height = is_edit_booking ? "370px" : "350px";
        document.getElementById('spnModalPage').style.top = is_edit_booking ? "-160px" : "-150px";
    }
...
function add_recurring_unavailability_booking() {
    ...
    if (page_type == "bookings") {
        ...
        // need to make sure atleast one day is selected
