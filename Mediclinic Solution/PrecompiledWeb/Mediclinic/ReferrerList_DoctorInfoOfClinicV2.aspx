<%@ page title="Referrer List (Doctor-Clinic)" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="ReferrerList_DoctorInfoOfClinicV2, App_Web_nvct1tre" %>
                            ...
                            <asp:GridView ID="GrdReferrer" runat="server" 
                                ...
                                <Columns> 
                                    ...
                                    <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left" FooterStyle-VerticalAlign="Top" SortExpression="name" ItemStyle-CssClass="text_left"> 
                                        ...
                                        <ItemTemplate> 
                                            <asp:HyperLink ID="lnkName" runat="server" Text='<%#  ( Eval("referrer_is_deleted") != DBNull.Value && (bool)Eval("referrer_is_deleted") ? "<font color=\"red\">[REFERRER DELETED]</font> " : "" ) + Eval("firstname") + " " + Eval("surname") %>' NavigateUrl='<%# "~/ReferrerList_DoctorsV2.aspx?referrer=" + Eval("original_referrer_id")%>'></asp:HyperLink>
