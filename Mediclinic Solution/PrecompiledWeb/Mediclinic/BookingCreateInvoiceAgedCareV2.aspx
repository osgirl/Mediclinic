<%@ page title="Complete Booking" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="BookingCreateInvoiceAgedCareV2, App_Web_nvct1tre" %>
                                        ...
                                        <ItemTemplate> 
                                            ...
                                            <table style="width:100%;">
                                                <tr>
                                                    ...
                                                    <td runat="server" Visible='<%# ProvsCanSeePricesWhenCompletingBks_AC() || !IsProviderView() %>'>&nbsp;&nbsp;</td>
                                                    <td style="text-align:right;">
                                                        <asp:Label ID="lblACInvOfferingCost" runat="server" Text='<%# Eval("patient_ac_offering_cost")  %>' Visible='<%# ProvsCanSeePricesWhenCompletingBks_AC() || !IsProviderView() %>' ></asp:Label> 
                                                    </td>
                                                </tr>
                                            </table>
                                        </ItemTemplate> 
                                            ...
                                            <asp:Repeater id="rptBkPtOfferings" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <tr style="vertical-align:top;">
                                                        ...
                                                        <td style="width:1px;"></td>
                                                        <td class="nowrap"><asp:Label ID="lblItemCost" runat="server" Text='<%# string.Format("{0:C}", ((decimal)Eval("offering_default_price") * (Convert.ToBoolean(Eval("offering_is_gst_exempt")) ? 1 : (  (100M + Convert.ToDecimal(((SystemVariables)System.Web.HttpContext.Current.Session["SystemVariables"])["GST_Percent"].Value))/100M   )))   ) %>' /></td>
                                                        <td style="width:1px;"></td>
                                                        <td class="nowrap"> = </td>
                                                        <td style="width:1px;"></td>
                                                        <td class="nowrap"><asp:Label ID="lblTotalcost" runat="server" Text='<%# string.Format("{0:C}", ((decimal)Eval("offering_default_price") * Convert.ToDecimal(Eval("bpo_quantity")) * (Convert.ToBoolean(Eval("offering_is_gst_exempt")) ? 1 : (  (100M + Convert.ToDecimal(((SystemVariables)System.Web.HttpContext.Current.Session["SystemVariables"])["GST_Percent"].Value))/100M   )))   )  %>' /></td>
