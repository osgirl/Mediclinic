<%@ control language="C#" autoeventwireup="true" inherits="InvoiceItemsControlV2, App_Web_2umnwf1k" %>
                    ...
                    <asp:GridView ID="GrdOffering" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="PT Price" HeaderStyle-HorizontalAlign="Left" SortExpression="pt_price" FooterStyle-VerticalAlign="Top"> 
                                <ItemTemplate> 
                                    <asp:Label ID="lblPTPrice" runat="server" Text='<%# Convert.ToDecimal(Eval("pt_price")) == 0 ? string.Empty : string.Format("{0:C}", Convert.ToDecimal(Eval("pt_price"))) %>'></asp:Label> 
                                </ItemTemplate> 
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="PT GST" HeaderStyle-HorizontalAlign="Left" SortExpression="pt_gst" FooterStyle-VerticalAlign="Top"> 
                                <ItemTemplate> 
                                    <asp:Label ID="lblPTGst" runat="server" Text='<%# Convert.ToDecimal(Eval("pt_price")) == 0 || Convert.ToDecimal(Eval("pt_gst")) == 0 ? string.Empty : string.Format("{0:C}", Convert.ToDecimal(Eval("pt_gst"))) %>'></asp:Label> 
                                </ItemTemplate> 
                            </asp:TemplateField> 
                            ...
                            <asp:TemplateField HeaderText="MC/DVA Price" HeaderStyle-HorizontalAlign="Left" SortExpression="hc_price" FooterStyle-VerticalAlign="Top"> 
                                <ItemTemplate> 
                                    <asp:Label ID="lblMCPrice" runat="server" Text='<%# Convert.ToDecimal(Eval("hc_price")) == 0 ? string.Empty : string.Format("{0:C}", Convert.ToDecimal(Eval("hc_price")))  %>'></asp:Label> 
                                </ItemTemplate> 
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="MC/DVA GST" HeaderStyle-HorizontalAlign="Left" SortExpression="hc_gst" FooterStyle-VerticalAlign="Top"> 
                                <ItemTemplate> 
                                    <asp:Label ID="lblMCGst" runat="server" Text='<%# Convert.ToDecimal(Eval("hc_price")) == 0 || Convert.ToDecimal(Eval("hc_gst")) == 0 ? string.Empty : string.Format("{0:C}", Convert.ToDecimal(Eval("hc_gst"))) %>'></asp:Label> 
                                </ItemTemplate> 
                            </asp:TemplateField> 
                ...
                <div id="autodivheight_otherconrol">
                    ...
                    <asp:GridView ID="GrdSelectedList" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Descr" HeaderStyle-HorizontalAlign="Left" SortExpression="name"> 
                                <ItemTemplate> 
                                    ...
                                    <div id="div" runat="server" visible='<%# Eval("is_dva") != DBNull.Value && (bool)Eval("is_dva") %>'>
                                        <br />
                                        Area Treated:<br />
                                        <asp:TextBox ID="txtAreaTreated" runat="server" Text='<%# Eval("area_treated") %>' />
                                    </div>
                            ...
                            <asp:ButtonField ButtonType="button" CommandName="AddOne" HeaderText="" HeaderStyle-BorderStyle="None" Text="+1" />
                            <asp:ButtonField ButtonType="button" CommandName="SubtractOne" HeaderText="" HeaderStyle-BorderStyle="None" Text="-1" />

                            <asp:TemplateField HeaderText="" Visible="False" HeaderStyle-BorderStyle="None"  ShowHeader="False" HeaderStyle-HorizontalAlign="Left" FooterStyle-VerticalAlign="Top"> 
                                <EditItemTemplate> 
                                ...
                                <ItemTemplate> 
                                    <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="False" CommandName="Edit" Text="Update Quantity"></asp:LinkButton> 
                                </ItemTemplate> 
                            </asp:TemplateField> 
