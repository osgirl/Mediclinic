<%@ control language="C#" autoeventwireup="true" inherits="PatientReferrerControlV2, App_Web_2umnwf1k" %>
...
<table>
    <tr id="displayHaveReferrerRow" runat="server" valign="top">
        <td class="nowrap" style="min-width:120px;">
            <asp:Label ID="lblReferrerText" runat="server" Text="Doctor: " Font-Bold="true" />&nbsp;
            <br />
    ...
    <tr id="editRow" runat="server" valign="top">
        <td class="nowrap" style="min-width:120px;">
            <asp:Label ID="lblReferrerText3" runat="server" Text="Doctor: " Font-Bold="true" />&nbsp;
        </td>
        <td style="min-width:8px;"></td>
    ...
    <tr id="displayNoReferrerRow" runat="server" valign="top">
        <td class="nowrap" style="min-width:120px;">
            <asp:Label ID="Label1" runat="server" Text="Doctor: " Font-Bold="true" />
        </td>
        <td style="min-width:8px;"></td>
        <td class="nowrap" align="center">
    ...
    <tr id="addRow" runat="server" valign="top">
        <td class="nowrap" style="min-width:120px;">
            <asp:Label ID="lblReferrerText2" runat="server" Text="Doctor: " Font-Bold="true" />&nbsp;
        </td>
        <td style="min-width:8px;"></td>
        <td class="nowrap" align="center">
    ...
    <tr id="newReferrersLinkRow" runat="server" height="35" valign="top">
        ...
        <td class="nowrap" colspan="4">
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:update_referrers();return false;">Doctor Not Found? Add New Doctor</a>
        </td>
    </tr>
</table>