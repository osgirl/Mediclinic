<%@ page title="Bookings Report" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="Report_BookingsV2, App_Web_g1nxmnfz" %>
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Date Added" SortExpression="booking_date_created" ItemStyle-CssClass="nowrap" ItemStyle-HorizontalAlign="Left"> 
                                <ItemTemplate> 
                                    ...
                                    <a runat="server" href="#" onclick="javascript:return false;" title='<%#  Eval("added_by_deleted_by_row") %>' style="text-decoration: none"><b>&nbsp;*&nbsp;</b></a>
                                </ItemTemplate> 
                            </asp:TemplateField> 
                            ...
                            <asp:TemplateField HeaderText="Inv Amt Less Adj Notes"  SortExpression="invoices_total"> 
                                <ItemTemplate> 
