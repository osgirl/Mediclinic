<%@ page title="Next Availalbe Booking" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="BookingNextAvailableV2, App_Web_v0sheksw" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        ...
        <div class="main_content_with_header">
            ...
            <center>
                <div id="autodivheight" runat="server" class="divautoheight" style="height:500px;">
