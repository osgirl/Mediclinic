<%@ page title="Manage Stock" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="StockListV2, App_Web_nvct1tre" %>
            ...
            <center>
                <div id="autodivheight" class="divautoheight" style="height:500px;display: inline-table !important;" >
                    ...
                    <div id="div_history_section" runat="server">
                        ...
                        <h4>Stock Update History &nbsp;&nbsp;&nbsp; <a href="#" onclick="expand_collapse('div_show_hide_stock_update_history');return false;">expand/collapse</a></h4>
