<%@ page title="Bookings" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="BookingsV2, App_Web_q34p1rur" %>
    ...
    <script type="text/javascript">
        ...
        document.onkeydown=function(e){ 
            ...
            if (e.which == 38 && isCtrl == true) { // alert("ctrl-up");
                show_hide('header_section', false)
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <asp:Label ID="lblIsPatientLogin" runat="server" CssClass="hiddencol"></asp:Label>
                    ...
                    <table style="width:75%">
                        <tr>
                            ...
                            <td style="width:26%;min-width:250px;text-align:center;">
                                <a href="#" class="showLink" onclick="show_hide('header_section');return false;">Hide/Show Header (Ctrl-UP/Down)</a>
                            </td>
                            <td style="width:11%;min-width:55px;"></td>
                            <td style="width:26%;min-width:250px;">
                                <a href="#" onclick="show_hide('div_fields_list'); return false">Show/Hide Booking Colour Key</a><br />
                                            ...
                                            <td style="width:350px;">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><asp:CheckBox ID="chkShowUnavailableStaff" runat="server" onclick="reload_booking_page_show_unavailable_staff();" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Show Bookings Details:</td>
                                                        <td><asp:CheckBox ID="chkShowDetails" runat="server" Checked="True" onclick="show_hide_booking_details(this.checked);" /></td>
                                                    </tr>
                                                </table>
        ...
        <script>
            ...
            function ShowMenu_Menu_Menu_Past_Uncompleted(elementID) { 
                ShowContextMenu(null, 
                        [
                         "Complete",
                         "Edit / Move",
            ...
            function ShowMenu_Menu_Menu_Future(elementID) { 
                ShowContextMenu(null, 
                        [
                         "Edit / Move",
                         "Delete",
            ...
            function ShowMenu_Menu_Menu_Future_PatientLoggedIn(elementID) { 
                ShowContextMenu(null, 
                        [
                         "Edit / Move",
                         "Delete"
            ...
            function ShowMenu_Menu_Menu_Past_Completed_Has_Invoice_Clinic(elementID) { 
                ShowMenu_Menu_Past_Completed_Has_Invoice (elementID)
            }
            function ShowMenu_Menu_Menu_Past_Completed_No_Invoice (elementID)
            {
            ...
            function GetTarget(e) {
                ...
                $('td.Menu_Past_Uncompleted').on("taphold", function (e) { 
                    e.preventDefault();
                    e.stopImmediatePropagation();
                ...
                $('td.Menu_Future').on("taphold", function (e) { 
                    e.preventDefault();
                    e.stopImmediatePropagation();
