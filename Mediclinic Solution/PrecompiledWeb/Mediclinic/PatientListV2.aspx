<%@ page title="Patient List" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="PatientListV2, App_Web_o4dos14t" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function show_hide_more_search_options(c) {
            if (c.checked) {
                document.getElementById("tr_bascSearch_Space").removeAttribute('class');
                document.getElementById("tr_basicSearch").removeAttribute('class');
                document.getElementById("tr_basicSearch_line2").removeAttribute('class');
                document.getElementById("tr_extendedSearch").removeAttribute('class');
                document.getElementById("tr_extendedSearch_line2").removeAttribute('class');
                document.getElementById("tr_extendedSearch_line3").removeAttribute('class');
                document.getElementById("tr_extendedSearch_line4").removeAttribute('class');
                document.getElementById("tr_extendedSearch_line5").removeAttribute('class');
                document.getElementById("tr_exportBtnRow").removeAttribute('class');
            }
            else {
                document.getElementById("tr_bascSearch_Space").setAttribute("class", "hiddencol");
                document.getElementById("tr_basicSearch").setAttribute("class", "hiddencol");
                document.getElementById("tr_basicSearch_line2").setAttribute("class", "hiddencol");
                document.getElementById("tr_extendedSearch").setAttribute("class", "hiddencol");
                document.getElementById("tr_extendedSearch_line2").setAttribute("class", "hiddencol");
                document.getElementById("tr_extendedSearch_line3").setAttribute("class", "hiddencol");
                document.getElementById("tr_extendedSearch_line4").setAttribute("class", "hiddencol");
                document.getElementById("tr_extendedSearch_line5").setAttribute("class", "hiddencol");
                document.getElementById("tr_exportBtnRow").setAttribute("class", "hiddencol");
            }
    ...
    <div class="clearfix">
        ...
        <div class="main_content_with_header">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="padding-left:20px;"><asp:CheckBox ID="chkShowDeleted" runat="server" AutoPostBack="True" OnCheckedChanged="chkShowDeleted_Submit" Text="" Font-Bold="false" />&nbsp;<label for="chkShowDeleted" style="font-weight:normal;">show deleted</label></span>
            ...
            <div>
                ...
                <table style="border-spacing:3px;border-collapse:separate;" class="block_center">

                    <tr id="tr_bascSearch_Space" runat="server">
                        <td colspan="12"></td>
                    </tr>

                    <tr id="tr_basicSearch" runat="server">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearch" runat="server">Search By Surname: </asp:Label></td>
                        ...
                        <td class="nowrap"><asp:Label ID="lblSearchPhNbr" runat="server">Search By Ph Nbr: </asp:Label></td>
                        <td style="width:165px"><asp:TextBox ID="txtSearchPhNum" runat="server"></asp:TextBox></td>
                        <td><asp:Button ID="btnSearchPhNum" runat="server" Text="Search" OnClick="btnSearchPhNum_Click" /></td>
                        <td><asp:Button ID="btnClearPhNumSearch" runat="server" Text="Clear" OnClick="btnClearPhNumSearch_Click" /><%-- <<== goes in there : OnClientClick="javascript:document.getElementById('txtSearchPhNum').value = ''; return false" --%></td>
                        <td id="phNumSearchResults" runat="server"></td>
                    </tr>

                    <tr  id="tr_basicSearch_line2" runat="server">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearchMedicareCardNo" runat="server">Search By Medicare Card No.: </asp:Label></td>
            
                        <td><asp:TextBox ID="txtSearchMedicareCardNo" runat="server"></asp:TextBox></td>
                        <td><asp:CheckBox ID="chkMedicareCardNoSearchOnlyStartWith" runat="server" Text="starts with" Font-Size="X-Small" /></td>

                        <td><asp:Button ID="btnSearchMedicareCardNo" runat="server" Text="Search" OnClick="btnSearchMedicareCardNo_Click" /></td>
                        <td><asp:Button ID="btnClearMedicareCardNoSearch" runat="server" Text="Clear" OnClick="btnClearMedicareCardNoSearch_Click" /></td>

                        <td style="width:40px"></td>

                        <td class="nowrap"><asp:Label ID="lblSearchDOB" runat="server">Search By DOB: </asp:Label></td>
                        ...
                        <td><asp:Button ID="Button5" runat="server" Text="Search" OnClick="btnSearchDOB_Click" /></td>
                        <td><asp:Button ID="Button6" runat="server" Text="Clear" OnClick="btnClearDOBSearch_Click" /></td>
                        <td></td>
                    </tr>

                    <tr id="tr_extendedSearch" runat="server" valign="top">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearchSuburb" runat="server">Search By Suburb: </asp:Label></td>
                        <td colspan="2"><asp:Label  ID="lblSuburbText" runat="server" Text="--" CssClass="nowrap" /></td>
                        <td>
                            <asp:Button ID="btnSearchSuburb" runat="server" Text="Select&nbsp;&nbsp;" OnClick="btnSearchSuburb_Click" OnClientClick="javascript:return get_suburb();" />
                        ...
                        <td><asp:Button ID="btnClearSuburbSearch" runat="server" Text="Clear" OnClick="btnClearSuburbSearch_Click" OnClientClick="javascript:clear_suburb();"/></td>

                        <td></td>

                        <td class="nowrap"><asp:Label ID="lblSearchStreet" runat="server">Search By Street: </asp:Label></td>
                        ...
                        <td><asp:Button ID="btnSearchStreet" runat="server" Text="Search" OnClick="btnSearchStreet_Click" /></td>
                        <td><asp:Button ID="btnClearStreetSearch" runat="server" Text="Clear" OnClick="btnClearStreetSearch_Click" /></td>
                        <td></td>
                    </tr>

                    <tr id="tr_extendedSearch_line2" runat="server" valign="top">
                        <td></td>

                        <td class="nowrap"><asp:Label ID="lblSearchInternalOrg" runat="server">Search By Clinic: </asp:Label></td>
                        <td><asp:Label ID="lblInternalOrgText" runat="server" Text="--" CssClass="nowrap" /></td>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSearchInternalOrg" runat="server" Text="Select&nbsp;&nbsp;" OnClick="btnSearchInternalOrg_Click" OnClientClick="javascript:return get_internal_org();" />
                            <asp:HiddenField ID="internalOrgID" runat="server" Value="0" />
                            <asp:Button ID="btnInternalOrgSelectionUpdate" runat="server" CssClass="hiddencol" Text=""  OnClick="btnInternalOrgSelectionUpdate_Click" />
                        </td>
                        <td><asp:Button ID="btnClearInternalOrgSearch" runat="server" Text="Clear" OnClick="btnClearInternalOrgSearch_Click" OnClientClick="javascript:clear_internal_org();"/></td>

                        <td></td>

                        <td></td>
                        <td align="right"><label for="chkOnlyDiabetics" style="font-weight:normal;">Only Diabetics</label>&nbsp;<asp:CheckBox ID="chkOnlyDiabetics" runat="server" Text="" TextAlign="Left" /></td>
                        <td><asp:Button ID="btnSearchOnlyDiabetics" runat="server" Text="Search" OnClick="btnSearchOnlyDiabetics_Click" /></td>
                        <td><asp:Button ID="btnClearOnlyDiabeticsSearch" runat="server" Text="Clear" OnClick="btnClearOnlyDiabeticsSearch_Click" /></td>
                        <td></td>
                    </tr>

                    <tr id="tr_extendedSearch_line3" runat="server" valign="top">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearchReferrerPerson" runat="server">Search By Referrer [Doctor]: </asp:Label></td>


                        <td colspan="2"><asp:Label ID="lblReferrerPersonText" runat="server" Text="--" CssClass="nowrap" /></td>
                        <td><asp:Button ID="btnSearchReferrerPerson" runat="server" Text="Select&nbsp;&nbsp;" OnClick="btnSearchReferrerPerson_Click" OnClientClick="javascript:return get_referrer_person();" /></td>
                        <td>
                            <asp:Button ID="btnClearReferrerPersonSearch" runat="server" Text="Clear" OnClick="btnClearReferrerPersonSearch_Click" OnClientClick="javascript:clear_referrer_person();"/>
                            <asp:HiddenField ID="referrerPersonID" runat="server" Value="-1" />
                            <asp:Button ID="btnReferrerPersonSelectionUpdate" runat="server" CssClass="hiddencol" Text=""  OnClick="btnReferrerPersonSelectionUpdate_Click" />
                        </td>
                    ...
                    <tr id="tr_extendedSearch_line4" runat="server" valign="top">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearchReferrerOrg" runat="server">Search By Referrer [Clinic]: </asp:Label></td>


                        <td colspan="2"><asp:Label  ID="lblReferrerOrgText" runat="server" Text="--" CssClass="nowrap" /></td>
                        <td><asp:Button ID="btnSearchReferrerOrg" runat="server" Text="Select&nbsp;&nbsp;" OnClick="btnSearchReferrerOrg_Click" OnClientClick="javascript:return get_referrer_org();" /></td>
                        <td>
                            <asp:Button ID="btnClearReferrerOrgSearch" runat="server" Text="Clear" OnClick="btnClearReferrerOrgSearch_Click" OnClientClick="javascript:clear_referrer_org();"/>
                            <asp:HiddenField ID="referrerOrgID" runat="server" Value="-1" />
                            <asp:Button ID="btnReferrerOrgSelectionUpdate" runat="server" CssClass="hiddencol" Text=""  OnClick="btnReferrerOrgSelectionUpdate_Click" />
                        </td>
                        <td colspan="3" align="right">
                            <label id="lblChkOnlyMedicareEPC" runat="server" for="chkOnlyMedicareEPC" style="font-weight:normal;">Only With Valid Medicare EPC</label>&nbsp;<asp:CheckBox ID="chkOnlyMedicareEPC" runat="server" Text="" TextAlign="Left" />
                        </td>


                        <td><asp:Button ID="btnSearchOnlyMedicareEPC" runat="server" Text="Search" OnClick="btnSearchOnlyMedicareEPC_Click" /></td>
                        <td><asp:Button ID="btnClearOnlyMedicareEPCSearch" runat="server" Text="Clear" OnClick="btnClearOnlyMedicareEPCSearch_Click" /></td>
                        <td></td>
                    </tr>

                    <tr id="tr_extendedSearch_line5" runat="server" valign="top">
                        <td></td>
                        <td class="nowrap"><asp:Label ID="lblSearchReferrer" runat="server">Search By Referrer [Doctor @ Clinic]: </asp:Label></td>


                        <td colspan="2"><asp:Label  ID="lblReferrerText" runat="server" Text="--" CssClass="nowrap" /></td>
                        <td><asp:Button ID="btnSearchReferrer" runat="server" Text="Select&nbsp;&nbsp;" OnClick="btnSearchReferrer_Click" OnClientClick="javascript:return get_referrer();" /></td>
                        <td>
                            <asp:Button ID="btnClearReferrerSearch" runat="server" Text="Clear" OnClick="btnClearReferrerSearch_Click" OnClientClick="javascript:clear_referrer();"/>
                            <asp:HiddenField ID="referrerID" runat="server" Value="-1" />
                            <asp:Button ID="btnReferrerSelectionUpdate" runat="server" CssClass="hiddencol" Text=""  OnClick="btnReferrerSelectionUpdate_Click" />
                        </td>
                        <td colspan="3" align="right">
                            <label for="chkOnlyDVAEPC" style="font-weight:normal;">Only With Valid DVA</label>&nbsp;<asp:CheckBox ID="chkOnlyDVAEPC" runat="server" Text="" TextAlign="Left" />
                        </td>


                        <td><asp:Button ID="btnSearchOnlyDVAEPC" runat="server" Text="Search" OnClick="btnSearchOnlyDVAEPC_Click" /></td>
                        <td><asp:Button ID="btnClearOnlyDVAEPCSearch" runat="server" Text="Clear" OnClick="btnClearOnlyDVAEPCSearch_Click" /></td>
                        <td></td>
                    </tr>



                    <tr id="tr_exportBtnRow" runat="server" valign="top">
                        <td colspan="11" align="center">
                            <br />
                            <asp:Button ID="btnExport" runat="server" Text="Export List" OnClick="btnExport_Click" />
                            <br />
                            <br />
                        </td>
                    </tr>
                    ...
                    <asp:GridView ID="GrdPatient" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="" ShowHeader="True" HeaderStyle-HorizontalAlign="Left" FooterStyle-VerticalAlign="Top">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnDelete" runat="server"  CommandName="_Delete" CommandArgument='<%# Bind("patient_id") %>' ImageUrl="~/images/Delete-icon-24.png" AlternateText="Delete" ToolTip="Delete" />
                                </ItemTemplate>
                            </asp:TemplateField>
