<%@ page title="Cost Centres" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="NotesV2, App_Web_o4dos14t" validaterequest="false" %>
    ...
    <div class="clearfix">
        ...
        <div class="main_content" style="padding:10px 5px;">
            ...
            <center>
                ...
                <asp:ValidationSummary ID="ValidationSummaryEdit" runat="server" CssClass="failureNotification" ValidationGroup="ValidationSummaryEdit2"/>
                                ...
                                <tr>
                                        ...
                                        <table class="pt_page_nav">
                                            <tr class="pt_page_nav">
                                                ...
                                                <td style="text-align:center;vertical-align:middle;margin-left:8px;" class="pt_page_nav">
                                                    <a id="link_tab1" href="#" onclick="show_tab('tab1');return false;" class="pt_page_nav" style="outline:none;"><asp:Label ID="lblHeading_tab1" runat="server">Booking Referrer Notes</asp:Label></a>
                                                </td>
                                                ...
                                                <td style="text-align:center;vertical-align:middle;" class="pt_page_nav">
                                                    <a id="link_tab3" href="#" onclick="show_tab('tab3');return false;" class="pt_page_nav" style="outline:none;"><asp:Label ID="lblHeading_tab3" runat="server">Booking Session Notes</asp:Label></a>
                                                </td>
                                                ...
                                                <td style="text-align:center;vertical-align:middle;margin-right:8px;" class="pt_page_nav">
                                                    <a id="link_tab2" href="#" onclick="show_tab('tab2');return false;" class="pt_page_nav" style="outline:none;"><asp:Label ID="lblHeading_tab2" runat="server">Patient Body Chart</asp:Label></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table style="text-align:center;line-height: 18px !important;">
                                            <tr>
                                                <td><asp:Label ID="lblSterilisationCode" runat="server">Sterilisation Code</asp:Label> </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtSterilisationCode" runat="server"  Columns="15"></asp:TextBox>
                                                </td>
                                                <td>
                                                    ...
                                                    <asp:TemplateField HeaderText="Note" HeaderStyle-HorizontalAlign="Left" SortExpression="text" FooterStyle-VerticalAlign="Top"> 
                                                        <EditItemTemplate> 
                                                            ...
                                                            <asp:RegularExpressionValidator ID="txtValidatetxtTextRegex" runat="server" CssClass="failureNotification"
                                                                ...
                                                                Display="Dynamic"
                                                                ValidationGroup="ValidationSummaryEdit1">*</asp:RegularExpressionValidator>
                                                        </EditItemTemplate> 
                                                        <FooterTemplate>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="txtValidatetxtNewTextRegex" runat="server" CssClass="failureNotification"
                                                                ...
                                                                ErrorMessage="The following letters are not permitted: '<', '>'"
                                                                Display="Dynamic"
                                                                ValidationGroup="ValidationSummaryAdd1">*</asp:RegularExpressionValidator>
                                                        </FooterTemplate> 
                                                        <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Note" HeaderStyle-HorizontalAlign="Left" SortExpression="text" FooterStyle-VerticalAlign="Top"> 
                                                                    <EditItemTemplate> 
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="txtValidatetxtTextRegex" runat="server" CssClass="failureNotification"
                                                                            ...
                                                                            ErrorMessage="The following letters are not permitted: '<', '>'"
                                                                            Display="Dynamic"
                                                                            ValidationGroup="ValidationSummaryEdit2">*</asp:RegularExpressionValidator>
                                                                    </EditItemTemplate> 
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtNewText" TextMode="multiline" rows="6" style="width:375px" runat="server" ></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="txtValidateNewTextRequired" runat="server" CssClass="failureNotification"  
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="txtValidatetxtNewTextRegex" runat="server" CssClass="failureNotification"
                                                                            ...
                                                                            ErrorMessage="The following letters are not permitted: '<', '>'"
                                                                            Display="Dynamic"
                                                                            ValidationGroup="ValidationSummaryAdd2">*</asp:RegularExpressionValidator>
                                                                    </FooterTemplate> 
                                                                    <ItemTemplate>
                                                                        <div style="width:375px;max-width:375px;text-align:left;">
                                                                            <asp:Label ID="lblText" runat="server" Text='<%# Eval("text") == DBNull.Value ? "" : ((string)Eval("text")).Replace("\n", "<br/>") %>'></asp:Label> 
                                                    ...
                                                    <asp:TemplateField HeaderText="Note" HeaderStyle-HorizontalAlign="Left" SortExpression="text" FooterStyle-VerticalAlign="Top"> 
                                                        <EditItemTemplate> 
                                                            ...
                                                            <asp:RegularExpressionValidator ID="txtValidatetxtTextRegex" runat="server" CssClass="failureNotification"
                                                                ...
                                                                ErrorMessage="The following letters are not permitted: '<', '>'"
                                                                Display="Dynamic"
                                                                ValidationGroup="ValidationSummaryEdit3">*</asp:RegularExpressionValidator>
                                                        </EditItemTemplate> 
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtNewText" TextMode="multiline" rows="6" style="width:375px" runat="server" ></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="txtValidateNewTextRequired" runat="server" CssClass="failureNotification"  
                                                            ...
                                                            <asp:RegularExpressionValidator ID="txtValidatetxtNewTextRegex" runat="server" CssClass="failureNotification"
                                                                ...
                                                                ErrorMessage="The following letters are not permitted: '<', '>'"
                                                                Display="Dynamic"
                                                                ValidationGroup="ValidationSummaryAd3d">*</asp:RegularExpressionValidator>
                                                        </FooterTemplate> 
                                                        <ItemTemplate>
                                                            <div style="width:375px;max-width:375px;text-align:left;">
                                                                <asp:Label ID="lblText" runat="server" Text='<%# Eval("text") == DBNull.Value ? "" : ((string)Eval("text")).Replace("\n", "<br/>") %>'></asp:Label> 
