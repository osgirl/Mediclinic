<%@ page title="Treatment Report" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="Invoice_ACTreatmentListV2, App_Web_o4dos14t" %>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnEmailToFac" runat="server" OnClick="btnEmailToFac_Click" Text="Email To Facility" />
                                            </td>
                                        </tr>
                                    </table>
