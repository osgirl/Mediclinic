<%@ page title="View Invoice" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="Invoice_ViewV2, App_Web_nvct1tre" %>
                                        ...
                                        <asp:Repeater id="Repeater15" runat="server" OnItemCreated="Repeater15_ItemCreated">
                                            <ItemTemplate>
                                                <td name='<%# Eval("td_name") %>' style="display:<%# Eval("style_display") %>;" style="vertical-align:top;" class="nowrap">
                                                    ...
                                                    <asp:Panel ID="pnlReceipts" runat="server" ScrollBars="Auto" style="max-height:85px;padding-right: 17px;">
