<%@ control language="C#" autoeventwireup="true" inherits="Bookings_BookingModalElementControlV2, App_Web_4sn1f5ik" %>
...
<div style="display: none;"  id="modalPopupPageLoadingMessage">
    <div class="modalBackground"></div>
    <div class="modalContainer">
...
<div style="display: none;"  id="modalPopup_Generic" oncontextmenu="return false;">
