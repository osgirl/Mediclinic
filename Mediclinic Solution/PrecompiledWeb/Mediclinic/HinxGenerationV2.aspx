<%@ page title="Hinx Generation" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="HinxGenerationV2, App_Web_v0sheksw" %>
                        ...
                        <div id="div_full_report" runat="server" class="text-left">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="min-width:300px">
                                        <a href="#" onclick="expand_collapse('div_invoice_list_to_be_claimed');return false;">expand/collapse</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" onclick="print_div('div_invoice_list_to_be_claimed');return false;">print</a>
                                    </td>
                                    <td>
                                        <a href="#" onclick="expand_collapse_all();return false;">expand/collapse all</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table style="margin-left:0; margin-right:0;">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="expand_collapse('div_invoice_list_partially_paid_claims');return false;">expand/collapse</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" onclick="print_div('div_invoice_list_partially_paid_claims');return false;">print</a>
                                    </td>
                                </tr>
                            </table>
                            <div style="line-height:7px;">&nbsp;</div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="expand_collapse('div_invoice_list_claim_manually');return false;">expand/collapse</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" onclick="print_div('div_invoice_list_claim_manually');return false;">print</a>
                                    </td>
                                </tr>
                            </table>
                            <div style="line-height:7px;">&nbsp;</div>
