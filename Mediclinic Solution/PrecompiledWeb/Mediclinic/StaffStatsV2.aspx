<%@ page title="Staff Stats" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="StaffStatsV2, App_Web_nvct1tre" %>
                ...
                <div class="border_top_bottom">
                    <table class="block_center">
                        <tr>
                            ...
                            <td><asp:CheckBox ID="chkIncDeleted" runat="server" Text="" Font-Bold="false" OnCheckedChanged="btnSearch_Click" />&nbsp;<label for="chkIncDeleted" style="font-weight:normal;">Include Fired</label></td>
                                ...
                                <HeaderTemplate>
                                    <table class="table table-bordered table-striped table-grid table-grid-top-bottum-padding-normal auto_width block_center">
                                        <tr>
                                            <th></th>
                                            <th></th>
                                            <th style="padding-left:5px;padding-right:5px;vertical-align:top;">New Bookings Added</th>
