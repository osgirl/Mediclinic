<%@ page title="Organisation List" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="OrganisationListV2, App_Web_q34p1rur" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><span id="lblHeading" runat="server">Staff List</span></div>
        <div class="main_content_with_header">
            <div class="user_login_form">
                ...
                <div class="border_top_bottom">
                        ...
                        <span style="padding-left:20px;"><asp:CheckBox ID="chkShowDeleted" runat="server" AutoPostBack="True" OnCheckedChanged="chkShowDeleted_CheckedChanged" Checked="False" /> &nbsp;<label for="chkShowDeleted" style="font-weight:normal;">show deleted</label> </span>
                </div>
