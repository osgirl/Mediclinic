<%@ page title="Complete Booking" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="BookingCreateInvoiceV2, App_Web_o4dos14t" enableeventvalidation="false" %>
        ...
        function live_search(str) {
            ...
            for (var i = 0; i < offeringLines.length; i++) {
                ...
                if (fields[0].toLowerCase().indexOf(str.toLowerCase()) != -1) {
                    ...
                    output += "<tr><td><a href='#' onclick=\"clear_live_search();document.getElementById('" + fields[1] + "').click();return false;\">" + fields[0] + "</a></td></tr>";
                }
            }
            output += "</table>";
