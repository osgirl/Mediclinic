<%@ page title="Patient Details" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="PatientDetailV3, App_Web_nvct1tre" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function show_tab(tabName) {
            ...
            show_hide('tab4', false);
            show_hide('tab5', false);
            show_hide('tab6', false);
            ...
            */
            ...
            document.getElementById('link_tab4').style.textDecoration = "";
            document.getElementById('link_tab5').style.textDecoration = "";
            document.getElementById('link_tab6').style.textDecoration = "";
                            ...
                            <table class="pt_page_nav">
                                <tr class="pt_page_nav">
                                    ...
                                    <td style="text-align:center;vertical-align:middle;margin-left:12px;" class="pt_page_nav">
                                        <a id="link_tab1" href="#" onclick="show_tab('tab1');return false;" class="pt_page_nav" style="outline:none;">History & Meds & Conditions</a>
                                    </td>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" class="pt_page_nav">
                                        <a id="link_tab2" href="#" onclick="show_tab('tab2');return false;" class="pt_page_nav" style="outline:none;">Current Consultations</a>
                                    </td>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" class="pt_page_nav">
                                        <a id="link_tab3" href="#" onclick="show_tab('tab3');return false;" class="pt_page_nav" style="outline:none;">Make Booking / Clinics</a>
                                    </td>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;" class="pt_page_nav">
                                        <a id="link_tab4" href="#" onclick="show_tab('tab4');return false;" class="pt_page_nav" style="outline:none;">Referrals</a>
                                    </td>
                                    ...
                                    <td style="text-align:center;vertical-align:middle;margin-right:12px;" class="pt_page_nav">
                                        <a id="link_tab6" href="#" onclick="show_tab('tab6');return false;" class="pt_page_nav" style="outline:none;">Attached files & Letters</a>
                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="lnkNotes" runat="server" ToolTip="Notes" Text="Add/Edit History" NavigateUrl="#" />
                                                                    &nbsp;&nbsp;
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td style="min-width:20px;"></td>
                                                                <td>
                                                                    <asp:HyperLink ID="lnkMedNotes" runat="server" ToolTip="Medications" Text="Add/Edit Medications" NavigateUrl="#" />
                                                                    &nbsp;&nbsp;
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td style="min-width:20px;"></td>
                                                                <td>
                                                                    <asp:HyperLink ID="lnkMedCondNotes" runat="server" ToolTip="Medical Conditions" Text="Add/Edit Medical Conditions" NavigateUrl="#" />
                                                                    &nbsp;&nbsp;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="nowrap">
                                                                            <table style="line-height:8px;">
                                                                                <tr>
                                                                                    <td><asp:CheckBox ID="chkIncDeleted" runat="server" Text="&nbsp;Inc. Deleted" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td><asp:CheckBox ID="chkIncCancelled" runat="server" Text="&nbsp;Inc. Cancelled" /></td>
                                                                                </tr>
                                                                            </table>
                                                            ...
                                                            <Columns> 
                                                                ...
                                                                <asp:TemplateField HeaderText="Referred To"  HeaderStyle-HorizontalAlign="Left" SortExpression="referral_id"> 
                                                                    <ItemTemplate> 
                                                                        ...
                                                                        <a href="#" onclick="get_register_referrer_forlist('<%# Eval("referral_id") %>');return false;"><%# Eval("register_referrer_id") != DBNull.Value ? "Change" : "Add" %></a>
                                                                    </ItemTemplate> 
                                                                    <EditItemTemplate> 
                                                                        <asp:Label ID="lblReferrer" runat="server" Text='<%# Eval("referrer_person_firstname") + " " + Eval("referrer_person_surname")  %>'></asp:Label> 
                                                                    </EditItemTemplate> 
                                                            ...
                                                            <tr style="vertical-align:top;">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Repeater id="lstCurrentFiles" runat="server" OnItemDataBound="lstCurrentFiles_ItemDataBound">
                                                                        ...
                                                                        <FooterTemplate>
                                                                                <tr>
                                                                                    <td><asp:Label ID="lblNoScannedDocsText" runat="server" Text="No Uploaded Documents."/></td>
                                                                                </tr>
                                                                            </table>
                                                                        </FooterTemplate>
                                                                    </asp:Repeater>
