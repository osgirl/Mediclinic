<%@ page title="Booking Sheet Blockout" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="BookingSheetBlockoutV2, App_Web_o4dos14t" %>
                    ...
                    <table id="tblInfoOnSettingSpecificUnavailabilities" runat="server" class="block_center" >
                        <tr>
                            <td style="text-align:left;">
                                <asp:Label ID="lblMessage_SpecificOrgSpecificProvider_DoFromBookingScreen" runat="server" ForeColor="Blue" Text="* To blockout a specific privider at a specific organsiation, do so directly from the booking sheet"/>
                                <br />
                                <asp:Label ID="lblMessage_SpecificProvider_DoFromProviderInfoScreen" runat="server" ForeColor="Blue" Text="* To blockout a specific privider, do so directly from the provider info screen"/>
                                <br />
