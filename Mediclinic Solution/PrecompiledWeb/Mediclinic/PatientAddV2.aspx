<%@ page title="Add Patient" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="PatientAddV2, App_Web_g1nxmnfz" %>
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:330px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="nowrap"><asp:TextBox ID="txtLogin" runat="server" TabIndex="9"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td></td>
                                    <td class="nowrap"><asp:TextBox ID="txtPwd" runat="server" TabIndex="10"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <b>Conditions</b> &nbsp; <span style="font-size:small;">(Add In Menu <b>Patients</b> → <b>Conditions</b>)</span>
                        ...
                        <td style="width:600px;">
                            ...
                            <table>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td class="nowrap">
                                                    <a id="lnkGetSuburb" runat="server" href="#" onclick="javascript:get_suburb(); return false;">Get Suburb</a>&nbsp;&nbsp;
                                                    <a id="lnkClearSuburb" runat="server" href="#" onclick="javascript:clear_suburb(); return false;">Clear Suburb</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td><asp:Label ID="lblIsBillingAddr" runat="server">Billing</asp:Label></td>
                                    <td></td>
                                    <td>
                                ...
                                <tr>
                                    <td><asp:Label ID="lblIsShippingAddr" runat="server">Shipping</asp:Label></td>
                                    <td></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="nowrap"><asp:Label ID="lblIsIncOnDocsDescr" runat="server">Inc On Docs</asp:Label></td>
                                    <td></td>
                                    <td>
