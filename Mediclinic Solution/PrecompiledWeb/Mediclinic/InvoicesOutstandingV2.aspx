<%@ page title="Outstanding Invoices" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="InvoicesOutstandingV2, App_Web_g1nxmnfz" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><span id="lblHeading">Outstanding Invoices</span></div>
                    ...
                    <tr style="vertical-align:top">
                        ...
                        <td>
                            ...
                            <center>
                                <table>
                                    <tr>
                                        <td><h4><asp:Label ID="lblFacHeading" runat="server">Outstanding By Facility&nbsp;&nbsp;&nbsp;&nbsp;</asp:Label></h4></td>
