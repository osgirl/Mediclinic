<%@ page title="Products & Services" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="OfferingListV2, App_Web_g1nxmnfz" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        ...
        <div class="main_content_with_header">
            <div class="user_login_form_no_width" style="width:1175px;"> 

                <div class="border_top_bottom user_login_form_no_width_div"">
                    <center>

                        <table class="padded-table-2px" style="margin:10px auto;">
                            <tr>
                                ...
                                <td><asp:CheckBox ID="chkSearchOnlyStartWith" runat="server" Text="&nbsp;starts with" /></td>
                                ...
                                <td><asp:CheckBox ID="chkUsePaging" runat="server" Text="&nbsp;use paging" AutoPostBack="True" OnCheckedChanged="chkUsePaging_CheckedChanged" Checked="True" /></td>
                                <td style="width:25px"></td>
                                <td><asp:CheckBox ID="chkShowDeleted" runat="server" Text="&nbsp;show deleted" AutoPostBack="True" OnCheckedChanged="chkShowDeleted_CheckedChanged" Checked="False" /></td>
                                <td style="width:60px"></td>
                                <td>
                                    ...
                                    <asp:Button ID="btnUpdateMedicarePrice" runat="server" CausesValidation="True" ValidationGroup="ValidationSummaryEditMcPrice" OnCommand="btnUpdatePrice_Command" CommandName="UpdateMedicarePriceAll" Text="Update All Medicare Prices" OnClientClick="return validate_and_confirm('Are you sure that you want to update the Medicare price for ALL products and services to $' + parseFloat(document.getElementById('txtNewPrice').value, 10).toFixed(2) + ' ?', 'ValidationSummaryEditMcPrice');" />
                                </td>
                            </tr>
                        </table>
                ...
                <div id="autodivheight" class="divautoheight" style="height:500px;">
                    ...
                    <asp:GridView ID="GrdOffering" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="TAC Charge" HeaderStyle-HorizontalAlign="Left" SortExpression="o_tac_charge" FooterStyle-VerticalAlign="Top" ItemStyle-Wrap="False"> 
                                <EditItemTemplate> 
                                    ...
                                    <asp:RequiredFieldValidator ID="txtValidateTacChargeRequired" runat="server" CssClass="failureNotification"  
                                        ...
                                        ErrorMessage="TAC Charge is required."
                                        Display="Dynamic"
                                        ValidationGroup="ValidationSummaryEdit" Enabled="False">*</asp:RequiredFieldValidator>
                                    <asp:RangeValidator ID="txtTacChargeIsCurrency" runat="server" CssClass="failureNotification" 
                                        ControlToValidate="txtTacCharge"
                                        Type="Currency" MinimumValue="0.00" MaximumValue="999.99" 
                                        ErrorMessage="TAC Charge must be a number and not more than 999.99."
                                        Display="Dynamic"
                                        ValidationGroup="ValidationSummaryEdit">*</asp:RangeValidator>
                                </EditItemTemplate> 
                                <FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Tac Code" HeaderStyle-HorizontalAlign="Left" SortExpression="o_tac_company_code" FooterStyle-VerticalAlign="Top"> 
                                <EditItemTemplate> 
