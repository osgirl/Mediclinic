<%@ page title="Invoices" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="Letters_RecallV2, App_Web_q34p1rur" %>
                                            ...
                                            <asp:GridView ID="GrdPatient" runat="server" 
                                                ...
                                                <Columns> 
                                                    ...
                                                    <asp:TemplateField HeaderText="Patient" HeaderStyle-HorizontalAlign="Left" SortExpression="person_firstname" FooterStyle-VerticalAlign="Top" ItemStyle-CssClass="text_left nowrap"> 
                                                        <ItemTemplate> 
                                                            <a href='#' onclick='<%# "open_new_tab(\"PatientDetailV2.aspx?type=view&id=" + Eval("patient_patient_id") + "\");return false;" %>' ><%# Eval("person_firstname") + " " + Eval("person_surname") %></a>
                                                        </ItemTemplate> 
                                                    </asp:TemplateField> 
