<%@ page title="Organisation Details" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="StaffDetailV2, App_Web_v0sheksw" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <div class="clearfix">
            <div class="page_title"><h3><asp:Label ID="lblHeading" runat="server" Text="Edit Organisation" /></h3></div>
                ...
                <table style="margin: 0 auto;" id="maintable" runat="server">
                    <tr style="vertical-align:top;">
                        <td>
                            ...
                            <table class="detailtable_organisation">
