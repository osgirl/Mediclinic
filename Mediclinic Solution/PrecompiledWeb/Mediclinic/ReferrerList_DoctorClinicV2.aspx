<%@ page title="Referrer List (Doctor-Clinic)" language="C#" masterpagefile="~/SiteV2.master" autoeventwireup="true" inherits="ReferrerList_DoctorClinicV2, App_Web_g1nxmnfz" %>
                    ...
                    <center>
                        ...
                        <table>
                            <tr>
                                ...
                                <td><asp:TextBox ID="txtSearchSurname" runat="server" onkeypress="javascript:if (event.which == 13 || event.keyCode == 13) document.getElementById('btnSearchSurname').click();"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td><asp:TextBox ID="txtSearchProviderNbr" runat="server" onkeypress="javascript:if (event.which == 13 || event.keyCode == 13) document.getElementById('btnSearchProviderNbr').click();"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td><asp:TextBox ID="txtSearchPhoneNbr" runat="server" onkeypress="javascript:if (event.which == 13 || event.keyCode == 13) document.getElementById('btnSearchPhoneNbr').click();"></asp:TextBox></td>
                    ...
                    <asp:GridView ID="GrdReferrer" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Move Patients"  HeaderStyle-HorizontalAlign="Left"> 
                                <ItemTemplate> 
                                    <asp:HyperLink ID="lnkMovePatients" runat="server" Text="Move" onclick='<%# "javascript:move_patients(" + Eval("register_referrer_id") + ",\"" + Eval("firstname") + " " + Eval("surname") + " [" + Eval("name") + "]\"); return false;"  %>' NavigateUrl='#' ></asp:HyperLink>
                                </ItemTemplate> 
                            </asp:TemplateField> 
