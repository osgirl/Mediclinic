<%@ Page Title="Add Patient" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="PatientAddV3.aspx.cs" Inherits="PatientAddV3" %>
                    ...
                    <tr style="vertical-align:top;">
                        <td style="width:330px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="nowrap"><asp:RegularExpressionValidator ID="txtValidateIDRegex" runat="server" CssClass="failureNotification" 
                                                ControlToValidate="txtID"
                                                ValidationExpression="^\d+$"
                                                ErrorMessage="ID can only be only digits and must contain at least one digit."
                                                Display="Dynamic"
                                    ...
                                    <td class="nowrap">
                                        <asp:TextBox ID="txtID" runat="server" style="width:75px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
