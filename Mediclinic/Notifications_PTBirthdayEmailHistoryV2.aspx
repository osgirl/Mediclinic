<%@ Page Title="Patient Email Birthday History" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="Notifications_PTBirthdayEmailHistoryV2.aspx.cs" Inherits="Notifications_PTBirthdayEmailHistoryV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><asp:Label ID="lblHeading" runat="server">Patient Email Birthday History</asp:Label></div>
