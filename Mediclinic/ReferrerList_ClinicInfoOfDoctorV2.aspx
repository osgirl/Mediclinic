<%@ Page Title="Referrer List (Doctor-Clinic)" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="ReferrerList_ClinicInfoOfDoctorV2.aspx.cs" Inherits="ReferrerList_ClinicInfoOfDoctorV2" %>
                            ...
                            <asp:GridView ID="GrdReferrer" runat="server" 
                                ...
                                <Columns> 
                                    ...
                                    <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left" FooterStyle-VerticalAlign="Top" SortExpression="name" ItemStyle-CssClass="text_left"> 
                                        <EditItemTemplate> 
                                            <asp:DropDownList ID="ddlOrgs" runat="server" DataTextField="name" DataValueField="organisation_id" />
                                        </EditItemTemplate> 
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlNewOrgs" runat="server" DataTextField="name" DataValueField="organisation_id" />
                                        </FooterTemplate> 
                                        <ItemTemplate> 
                                            <asp:HyperLink ID="lnkName" runat="server" Text='<%# ( Eval("organisation_is_deleted") != DBNull.Value && (bool)Eval("organisation_is_deleted") ? "<font color=\"red\">[CLINIC DELETED]</font> " : "" ) + Eval("name") %>' NavigateUrl='<%# "~/ReferrerList_ClinicsV2.aspx?org=" + Eval("original_organisation_id")%>'></asp:HyperLink>
                                            (<asp:HyperLink ID="lnkReferrers" runat="server" Text="Doctors" NavigateUrl='<%# "~/ReferrerList_DoctorInfoOfClinicV2.aspx?org=" + Eval("original_organisation_id")%>'></asp:HyperLink>)
                                        </ItemTemplate> 
                                    </asp:TemplateField> 
