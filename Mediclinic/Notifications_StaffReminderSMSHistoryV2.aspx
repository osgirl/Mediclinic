<%@ Page Title="Staff SMS Reminders History" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="Notifications_StaffReminderSMSHistoryV2.aspx.cs" Inherits="Notifications_StaffReminderSMSHistoryV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><asp:Label ID="lblHeading" runat="server">Staff SMS Reminders History</asp:Label></div>
