<%@ Page Title="Patient SMS Reminders History" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="Notifications_PTReminderSMSHistoryV2.aspx.cs" Inherits="Notifications_PTReminderSMSHistoryV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><asp:Label ID="lblHeading" runat="server">Patient SMS Reminders History</asp:Label></div>
