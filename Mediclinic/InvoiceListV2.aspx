<%@ Page Title="Invoices" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="InvoiceListV2.aspx.cs" Inherits="InvoiceListV2" %>
                        ...
                        <asp:Panel ID="pnlDefaultButton" runat="server" DefaultButton="btnDefaultButton_NoSubmit" style="margin:6px auto;">
                            ...
                            <table>
                                <tr>
                                    <td id="td_search_dates" runat="server">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="nowrap"><asp:TextBox ID="txtStartDate" runat="server" Columns="10" onkeydown="return doClick('btnSearch',event);"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="nowrap"><asp:TextBox ID="txtEndDate" runat="server" Columns="10" onkeydown="return doClick('btnSearch',event);"/></td>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <div style="width:100%;max-width:245px;">
                                        ...
                                        <table style="line-height:10px;">
                                            <tr style="vertical-align:top;">
                                                <td class="nowrap">
                                                    ...
                                                    <br />
                                                    <asp:CheckBox ID="chkIncTAC"       runat="server" Text="&nbsp;Inc Insurance"/>
                                                    <br />
                                    ...
                                    <td id="td_search_button" runat="server">
                                        <asp:Button ID="btnSearch" runat="server" Text="Update" OnClick="btnSearch_Click" style="width:100%" />
                                        <br />
                                        <asp:Button ID="btnPrint" runat="server" Text="Print" OnClick="btnPrint_Click" style="width:100%" Visible="false" />
                                        <asp:Button ID="btnExport" runat="server" Text="Export" OnClick="btnExport_Click" style="width:100%" />
                                    </td>
                    ...
                    <asp:GridView ID="GrdInvoice" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Invoice #"  HeaderStyle-HorizontalAlign="Left" SortExpression="inv_invoice_id" HeaderStyle-CssClass="nowrap" ItemStyle-CssClass="nowrap" FooterStyle-BorderStyle="None"> 
                                <ItemTemplate> 
                                    <asp:HyperLink ID="lnkId" runat="server" Text='<%# Bind("inv_invoice_id") %>' ></asp:HyperLink>
                                    ...
                                    <a id="A1" runat="server" href="javascript:void(0)" onclick="javascript:return false;" title='<%#  Eval("added_by_reversed_by_row") %>' style="text-decoration: none"><b>&nbsp;*&nbsp;</b></a>
                                </ItemTemplate> 
                            </asp:TemplateField> 
                            ...
                            <asp:TemplateField HeaderText="Vouchers" HeaderStyle-HorizontalAlign="Left" SortExpression="inv_vouchers_total" FooterStyle-VerticalAlign="Top" FooterStyle-BorderStyle="None" FooterStyle-CssClass="nowrap">
                                <ItemTemplate> 
