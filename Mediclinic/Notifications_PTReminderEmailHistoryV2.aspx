<%@ Page Title="Patient Email Reminders History" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="Notifications_PTReminderEmailHistoryV2.aspx.cs" Inherits="Notifications_PTReminderEmailHistoryV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><asp:Label ID="lblHeading" runat="server">Patient Email Reminders History</asp:Label></div>
                ...
                <div id="autodivheight" class="divautoheight" style="height:500px;">
                    ...
                    <asp:GridView ID="GrdEmailHistory" runat="server" 
                        ...
                        <Columns> 
                            ...
                            <asp:TemplateField HeaderText="Email"  HeaderStyle-HorizontalAlign="Left" SortExpression="email" ItemStyle-CssClass="text_left"> 
                                <ItemTemplate> 
