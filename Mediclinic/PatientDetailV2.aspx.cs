...
public partial class PatientDetailV2 : System.Web.UI.Page
{
    ...
    private void FillEditViewForm(Patient patient, bool isEditMode)
    {
        ...
        FillGrdReferrerAdditionalEmails(patient);
        if (debugPageLoadTime) Logger.LogQuery("-B9", false, false, true);
        ...
        if (debugPageLoadTime) Logger.LogQuery("-90", false, false, true);
    ...
    protected void FillGrdReferrerAdditionalEmails(Patient patient = null)
    {
        try
        {
            if (patient == null)
