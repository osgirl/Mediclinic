...
public partial class StaffListV2 : System.Web.UI.Page
{
    ...
    protected void GrdStaff_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (!tblEmpty && e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (ddlField != null)
            {
                ...
                if (ddlField.Items.FindByValue(thisRow["field_id"].ToString()) == null)
                    ddlField.Items.Add(new ListItem(thisRow["field_descr"].ToString(), thisRow["field_id"].ToString()));
