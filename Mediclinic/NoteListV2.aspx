<%@ Page Title="Cost Centres" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="NoteListV2.aspx.cs" Inherits="NoteListV2" ValidateRequest="false" %>
                     ...
                     <tr>
                         ...
                         <td>
                            ...
                            <center>
                                ...
                                <a href="javascript:void(0)" onclick="send_email(); return false;" style="display:none;">Email Notes</a>
                            ...
                            <div id="autodivheight" class="divautoheight" style="min-height:235px; height:500px; width: auto; padding-right: 17px;">
                                ...
                                <asp:GridView ID="GrdNote" runat="server" 
                                    ...
                                    <Columns> 
                                        ...
                                        <asp:TemplateField HeaderText="Medical Service Type" HeaderStyle-HorizontalAlign="Left" SortExpression="medical_service_type_descr" FooterStyle-VerticalAlign="Top"> 
                                            <EditItemTemplate> 
                                                <asp:DropDownList ID="ddlMedicalServiceType" runat="server" DataTextField="descr" DataValueField="medical_service_type_id"></asp:DropDownList>
                                            </EditItemTemplate> 
                                            <ItemTemplate> 
                                                <asp:Label ID="lblMedicalServiceType" runat="server" Text='<%# Eval("medical_service_type_descr") %>'></asp:Label> 
                                            </ItemTemplate> 
                                            <FooterTemplate> 
                                                <asp:DropDownList ID="ddlNewMedicalServiceType" runat="server" DataTextField="descr" DataValueField="medical_service_type_id"></asp:DropDownList>
                                            </FooterTemplate> 
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField HeaderText="Note" HeaderStyle-HorizontalAlign="Left" SortExpression="text" FooterStyle-VerticalAlign="Top"> 
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:RegularExpressionValidator ID="txtValidatetxtNewTextRegex" runat="server" CssClass="failureNotification"
                                                    ...
                                                    ErrorMessage="The following letters are not permitted: '<', '>'"
                                                    Display="Dynamic"
                                                    ValidationGroup="ValidationSummaryAdd" Enabled="false">*</asp:RegularExpressionValidator>
                                            </FooterTemplate> 
                                            <ItemTemplate>
