<%@ Page Title="Staff Stats" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="StaffStatsChartsV2.aspx.cs" Inherits="StaffStatsChartsV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><span id="lblHeading" runat="server">Staff Statistics Charts</span></div>
                ...
                <div class="border_top_bottom">
                    <table class="block_center">
                        <tr>
                            ...
                            <td rowspan="2"><asp:CheckBox ID="chkIncDeleted" runat="server" Text="" Font-Bold="false" OnCheckedChanged="btnSearch_Click" />&nbsp;<label for="chkIncDeleted" style="font-weight:normal;">Include Inactive</label></td>
            ...
            <table class="block_center">
                <tr>
                    <td>
                        ...
                        <asp:Chart ID="chartStaffStats" runat="server" 
                           BackColor="#EDEDED" 
                            Width="900px" 
                            Height="900px">
