<%@ Page Title="Schedule Report" Language="C#" MasterPageFile="~/SiteV2.master" AutoEventWireup="true" CodeFile="Report_ScheduleV2.aspx.cs" Inherits="Report_ScheduleV2" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="clearfix">
        <div class="page_title"><asp:Label ID="lblHeading" runat="server">Schedule Report</asp:Label></div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="nowrap" style="vertical-align:middle;">
                                        ...
                                        <br />
                                        <asp:CheckBox ID="chkIncBookings" runat="server" Text="&nbsp;Inc Bookings" CssClass="chkbox_spaceleft" />
                                        <br />
