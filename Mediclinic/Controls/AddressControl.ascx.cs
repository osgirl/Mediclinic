...
public partial class Controls_AddressControl : System.Web.UI.UserControl
{
    ...
    protected void SetGUI()
    {
        ...
        string allFeaturesAddAddress = "dialogWidth:525px;dialogHeight:425px;center:yes;resizable:no; scroll:no";
        //string jsAddAddress = "javascript:window.showModalDialog('AddEditContact.aspx?type=add" + entity_type + "&id=" + this.EntityID.ToString() + "&contact_type_group=1', '', '" + allFeaturesAddAddress + "'); document.getElementById('" + btnUpdateAddresses.ClientID + "').click();return false;";
        string jsAddAddress = "javascript:window.showModalDialog('AddEditContact.aspx?type=add" + entity_type + "&id=" + this.EntityID.ToString() + "&contact_type_group=1', '', '" + allFeaturesAddAddress + "'); window.location.href = window.location.href;return false;";
        ...
        string allFeaturesOther = "dialogWidth:460px;dialogHeight:250px;center:yes;resizable:no; scroll:no";
        string jsAddPhoneNums = "javascript:window.showModalDialog('AddEditContact.aspx?type=add" + entity_type + "&id=" + this.EntityID.ToString() + "&contact_type_group=2', '', '" + allFeaturesOther + "'); window.location.href = window.location.href;;return false;";
        string jsAddEmails = "javascript:window.showModalDialog('AddEditContact.aspx?type=add" + entity_type + "&id=" + this.EntityID.ToString() + "&contact_type_group=4', '', '" + allFeaturesOther + "'); window.location.href = window.location.href;return false;";
        string jsAddBedrooms = "javascript:window.showModalDialog('AddEditContact.aspx?type=add" + entity_type + "&id=" + this.EntityID.ToString() + "&contact_type_group=3', '', '" + allFeaturesOther + "'); window.location.href = window.location.href;return false;";
        ...
        this.lblBedrooms.Visible = this.IncBedrooms;
        this.lnkAddBedrooms.Visible = this.IncBedrooms;
    ...
    protected TableRow CreateNewRow(Contact contact, int width, int height, bool hasFreeTextRow = false, bool isFreeTextRow = false)
    {
        ...
        if (rowspan > 0)
        {
            ...
            //string onclick     = "onclick=\"javascript:window.showModalDialog('AddEditContact.aspx?type=edit&id=" + contact.ContactID.ToString() + "', '', '" + allFeatures + "');document.getElementById('" + btnUpdateAddresses.ClientID + "').click();return false;\"";
            string onclick = "onclick=\"javascript:window.showModalDialog('AddEditContact.aspx?type=edit&id=" + contact.ContactID.ToString() + "', '', '" + allFeatures + "');window.location.href=window.location.href;return false;\"";
        ...
        if (isAddress)
        {
            ...
            else
            {
                ...
                tr.Cells.Add(NewCell(contact.AddressChannel == null ? "" : contact.AddressChannel.DisplayName, true));
                tr.Cells.Add(NewCell("&nbsp;"));
