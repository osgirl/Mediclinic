    ...
    protected void GrdPatient_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (!tblEmpty && e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lnkFirstname != null)
                lnkFirstname.NavigateUrl = Patient.GetPatientDetailPage(Convert.ToInt32(thisRow["patient_id"]), Convert.ToBoolean(thisRow["is_gp_patient"]), Convert.ToInt32(Session["SiteTypeID"]) == 3);
