...
public class EmailerNew
{
    ...
    public static void SimpleEmail(string to, string subject, string body, bool isHTML, string[] attachments, bool deleteAttachmentsAfterSent, System.Net.Mail.AlternateView[] alternativeViews)
    {
        SimpleEmail(
            ...
            isHTML,
            attachments,
            deleteAttachmentsAfterSent,
            alternativeViews);
    }
    public static void SimpleEmail(string from_name, string to, string subject, string body, bool isHTML, string[] attachments, bool deleteAttachmentsAfterSent, System.Net.Mail.AlternateView[] alternativeViews)
    {
        SimpleEmail(
    ...
    public static void SimpleEmail(string from_email, string from_name, string to, string subject, string body, bool isHTML, string[] attachments, bool deleteAttachmentsAfterSent, System.Net.Mail.AlternateView[] alternativeViews, string BCC = null)
    {
        SimpleEmail(
            from_email,
            from_name,
    ...
    protected static void SimpleEmail(string from_address, string from_name, string to, string subject, string body, bool isHTML,
                                   string smtp_host, int smtp_port, string accountUsername, string accountPassword, string[] attachments, bool deleteAttachmentsAfterSent, System.Net.Mail.AlternateView[] alternativeViews, string BCC = null)
    {
        ...
        try
        {
            ...
            if (BCC != null)
                foreach (string _bcc in BCC.Split(','))
            ...
            if (deleteAttachmentsAfterSent && attachments != null)
            {
                for (int i = 0; i < attachments.Length; i++)
                {
                    try { if (System.IO.File.Exists(attachments[i])) System.IO.File.Delete(attachments[i]); }
                    catch (Exception) { }
                }
            }
        }
